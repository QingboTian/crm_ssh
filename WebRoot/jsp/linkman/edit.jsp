					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								<input type="radio" value="男" name="lkm_gender" <c:if test="${linkman.lkm_gender=='男' }">checked</c:if>>男
								
								<input type="radio" value="女" name="lkm_gender" <c:if test="${linkman.lkm_gender=='女' }">checked</c:if>>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
